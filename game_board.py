...
class GameBoard:
                ...
                if value == Sign.LETTER_O:
                    if j != 0 and j != self.get_size() - 1:
                        if (
                            ...
                            sos_count += 1  # horizontal sos found
                    ...
                    if i != 0 and i != self.get_size() - 1:
                        if (
                            ...
                            sos_count += 1  # vertical sos found
                    ...
                    if (
                        ...
                        if (
                            ...
                            sos_count += 1  # neg diag sos found

                        if (
                            self._board[i - 1][j + 1] == Sign.LETTER_S
                            and self._board[i + 1][j - 1] == Sign.LETTER_S
                        ):
                            sos_count += 1  # pos diag sos found
        return sos_count
    
    #check if  x and y location is in range
    def is_in_range(self, location: Location) -> bool:
        return 0 <= location.x < self._size and 0 <= location.y < self._size

    #find almost sos that can be completed by the next move 1.SES 2.SOE
    ...
    #move is ok if it is in range and empty
